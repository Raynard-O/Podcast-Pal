...
def result():
    ...
    url = 'https://listen-api.listennotes.com/api/v2/search?q=' + newkeyword + '&sort_by_date=0&type=episode&offset=0' \
                                                                               '&len_min=1&len_max=2&genre_ids=68' \
...
def podcast_details():
    ...
    if request.form.get('audio') is not None:
        ...
        url = 'https://listen-api.listennotes.com/api/v2/podcasts/' + recommender_input_id + '?next_episode_pub_date' \
                                                                                             '=1479154463000&sort' \
                                                                                             '=recent_first '
        ...
        for i in rec_podcast_ids:
            url = 'https://listen-api.listennotes.com/api/v2/podcasts/' + i + '?next_episode_pub_date=1479154463000' \
                                                                              '&sort=recent_first '
